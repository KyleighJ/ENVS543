...
```
A correlation test was conducted to assess the relationship between sex ratio (MFRatio) and elevation across sample sites. The results indicated a non-significant negative correlation between sex ratio and elevation, t = -0.55949, df = 29, p-value = 0.5801, with a 95% confidence interval [-0.4415112  0.2605426], and cor = -.103

This suggests that there is no statistically significant correlation between sex ratio and elevation within the sampled Baja region.
